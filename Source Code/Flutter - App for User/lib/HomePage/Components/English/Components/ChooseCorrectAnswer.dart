...
class ChooseCorrectAnswer extends StatefulWidget {
  ...
  const ChooseCorrectAnswer({super.key, required this.isPressedCourse, required this.isPressedLessons});
  @override
  _ChooseCorrectAnswerState createState() => _ChooseCorrectAnswerState();
}
...
class _ChooseCorrectAnswerState extends State<ChooseCorrectAnswer> {
  ...
  void loadAudio(int isPressedCourse, isPressedLesson) async {
    List<String> Audios = await FireBaseRealTimeDataBase.fetchCourse(
        "languages/0/courses/$isPressedCourse/lessons/$isPressedLesson/exercises/4/questions", "audio_url");
    List<String> CrAW = await FireBaseRealTimeDataBase.fetchCourse(
        "languages/0/courses/$isPressedCourse/lessons/$isPressedLesson/exercises/4/questions", "correct_answer");
    List<String> Ques = await FireBaseRealTimeDataBase.fetchCourse(
        "languages/0/courses/$isPressedCourse/lessons/$isPressedLesson/exercises/4/questions", "name");
    List<int> ids = await FireBaseRealTimeDataBase.getList(
        "languages/0/courses/$isPressedCourse/lessons/$isPressedLesson/exercises/4/questions", "id");
    setState(() {
      AudiosString = Audios;
      QuesList = Ques;
